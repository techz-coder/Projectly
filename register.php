    ...
    <div class="row justify-content-center">
        <div class="col-lg-9">
            ...
            <form id="register_form" method="post" action="insertQuery.php">
                <div class="row g-3">
                    <div class="col-md-6">
                        <label for="your-email" class="form-label">Your Name</label>
                        <input type="text" class="form-control" id="name" name="name" required placeholder="Name">
                    </div>
                    <div class="col-md-6">
                        <label for="your-name" class="form-label">Mobile</label>
                    ...
                    <div class="col-12">
                        <div class="row">
                            <div class="col-md-6">
                                <input type="submit" value="Register" name="register_btn" id="register" class="btn btn-dark w-100 fw-bold">
                            </div>
                        </div>
